...
- **Regional web tier:** an **Application Load Balancer (ALB)** receives traffic after **AWS WAF**, with WAF logs to **S3**; the ALB ties to **AWS Auto Scaling** and **alarms** for scaling and health.
